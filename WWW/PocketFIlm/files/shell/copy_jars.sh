...
# 将 jar 包上传到服务器
	...
	scp ../jars/*.jar root@149.129.94.197:/usr/local/projects/PocketFilm/files/jars/
	echo '已完成'
else
for var in ${array[@]}
do
	...
	scp ../jars/${var}-*.jar root@149.129.94.197:/usr/local/projects/PocketFilm/files/jars/
	echo '已完成'
done
fi