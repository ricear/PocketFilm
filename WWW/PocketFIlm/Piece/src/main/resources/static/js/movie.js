$(function () {
    //  推荐
    var recommendations_url = API + "/recommendations/get/user?user_name=" + username + "&browse_type=piece&page_size=" + pageSize;
    //  热门推荐
    var hottest_movies_url = API + "/piece/get/all?page_size=" + pageSize;
    //  今日更新
