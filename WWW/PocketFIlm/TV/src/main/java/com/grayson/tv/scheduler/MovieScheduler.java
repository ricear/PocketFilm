package com.grayson.tv.scheduler;
...
public class MovieScheduler {
    ...
    public void saveMainHtml() {
        ...
        String filePath = Configs.MAIN_HTML_SAVE_FILE_PATH + "/TV/src/main/resources/static/html";
        String fileName = "main.html";
        commonUtils.saveHtml("http://tv.grayson.top/main", filePath, fileName);
