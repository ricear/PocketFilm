...
$(function () {
    //  获取影视数据
    var more_movie_url = API + "/drama/get/all?type=" + type + "&page_index=" + page_index + "&page_size=" + pageSize + "&key_word=" + key_word + "";
    get_movies(more_movie_url, 'more-movies')
    //  获取影视资源数量
    var count_movie_url = API + "/count/get?source_type=drama&type=" + type + "&page_index=" + page_index + "&page_size=" + pageSize + "&key_word=" + key_word + "";
