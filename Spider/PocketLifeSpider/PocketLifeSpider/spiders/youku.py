...
class YoukuSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://list.youku.com/category/page?c=96&s=6&type=show&p=1',
        'https://list.youku.com/category/page?c=97&s=6&type=show&p=1',
        'https://list.youku.com/category/page?c=85&s=6&type=show&p=1',
        'https://list.youku.com/category/page?c=100&s=6&type=show&p=1',
        'https://list.youku.com/category/page?c=177&s=6&type=show&p=1'
    ]
    ...
    def parse(self, response):
        ...
        # 生成视频列表地址
        for i in reverse_arr(range(1, 16)):
