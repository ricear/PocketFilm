...
def text_watermark(source_file, out_base_path='.', text='@Grayson', angle=23, opacity=0.50):
    '''''
...
if __name__ == "__main__":
    ...
    主要是实现功能， 代码没怎么整理 
    '''
    # im = Image.open('WechatIMG8.jpeg')  # image 对象
    # compress_image(im)
    #
    # im = Image.open('WechatIMG8.jpeg')  # image 对象
    # cut_image(im)
    ...
    im = Image.open(abspath + '/WechatIMG8.jpeg')  # image 对象
    text_watermark(im)
