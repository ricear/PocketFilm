...
var MoreRecommendMoviePage = /** @class */ (function () {
    ...
    MoreRecommendMoviePage.prototype.getTvsTemp = function () {
        ...
        var promise = new Promise(function (resolve, error) {
            _this.tools.getRecommendationsByUserApi(_this.browse_type, _this.type, _this.limit, _this.pageIndex, _this.pageSize).then(function (data) {
                // 截取电影名称的长度
                var name_length = 5;
                if (data.code == 0) {
