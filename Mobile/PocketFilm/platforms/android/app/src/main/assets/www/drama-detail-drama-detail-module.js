...
module.exports = ".detailPosterIntro .introTxt {\n  height: auto; }\n\nh1 {\n  margin-top: auto; }\n\n.globalPadding {\n  padding-left: 0px; }\n\n.introTxt h1 {\n  list-style: none;\n  text-overflow: ellipsis;\n  white-space: nowrap;\n  overflow: hidden; }\n\n.introTxt span {\n  font: 12px/1.5 Arial,\\5FAE\\8F6F\\96C5\\9ED1;\n  display: inline-block; }\n\nion-segment-button button {\n  padding: 0px; }\n\n.tab2 dt span.current {\n  background: #f04141; }\n\n.tab2 dd {\n  border-top: 1px solid #f04141; }\n\n.tab {\n  height: 62px;\n  line-height: 48px;\n  font-size: 18px;\n  padding-bottom: 0px; }\n\n.ulNumList li {\n  width: auto; }\n\n.picTxt .con .sNum .emScore {\n  color: #fff; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var DramaDetailPage = /** @class */ (function () {
     ...
     * @param id 资源列表名称
     */
    DramaDetailPage.prototype.oooTab = function (id, source_index) {
     ...
     * @param id 资源列表或简介id
     */
    DramaDetailPage.prototype.oooTab2 = function (id) {
    ...
    DramaDetailPage.prototype.getDrama = function () {
        ...
        this.tools.getDramaByIdApi(this._id).then(function (data) {
            ...
            // 获取影视推荐信息
            _this.tools.getRecommendationsApi(_this.tv._id, 'drama').then(function (data) {
                var top10Movies = [];
