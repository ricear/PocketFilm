...
var MacPlayer = {
    ...
    Show: function() {
        ...
        $("#playleft").get(0).innerHTML = '<iframe id="buffer" sandbox="allow-forms allow-scripts"  src="' + this.Prestrain + '" frameBorder="0" scrolling="no" width="100%" height="' + this.Height + '" style="position:absolute;z-index:99998;"></iframe>' + this.Html + "";
