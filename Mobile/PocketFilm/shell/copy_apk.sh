...
scp ../platforms/android/app/build/outputs/apk/debug/PocketFilm.apk root@149.129.94.197:/usr/local/projects/PocketFilm/Web/PocketFilm/public/apks
echo '已完成'
echo '将新编译好的browser文件复制到服务器html目录下面'
scp -r ../platforms/browser/www/* root@149.129.94.197:/usr/local/projects/PocketFilm/MobileWeb/PocketFilm/html
echo '已完成'